/////////////////////////////////////////////////////////////////////////////
//	Registry.cpp : Implementation file of the CRegistry class
...
/*
$Header: /InfoView/Registry.cpp 1     9/14/98 1:21p Suresh $
*/
...
LONG CRegistry::GetRegInfoMessage() const
{
	return m_Info.lMessage;
}

DWORD CRegistry::GetRegInfoType() const
{
	return m_Info.dwType;
}

DWORD CRegistry::GetRegInfoSize() const
{
	return m_Info.dwSize;	
}

DWORD CRegistry::GetRegKeyType(LPCTSTR pszKey) const
{
	ASSERT(m_hKey);
	ASSERT(pszKey);
