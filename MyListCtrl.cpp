...
void MyListCtrl::DrawItem(LPDRAWITEMSTRUCT lpDrawItemStruct)
{
    ...
    if( bHighlight )
    {
        ...
        pDC->FillRect(rcHighlight, &CBrush(::GetSysColor(COLOR_3DHIGHLIGHT)));
    }
    else
...
void MyListCtrl::RepaintSelectedItems()
{
...
void MyListCtrl::OnKillFocus(CWnd* pNewWnd) 
{
...
void MyListCtrl::OnSetFocus(CWnd* pOldWnd) 
{
...
int MyListCtrl::SetHighlightType(EHighlight hilite)
{
